...
static constexpr auto qt_meta_stringdata_CLASSLogENDCLASS = QtMocHelpers::stringData(
    "Log",
    "initWork",
    "",
    "signalWriteToLog",
...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_CLASSLogENDCLASS_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_CLASSLogENDCLASS_t qt_meta_stringdata_CLASSLogENDCLASS = {
    {
        QT_MOC_LITERAL(0, 3),  // "Log"
        QT_MOC_LITERAL(4, 8),  // "initWork"
        QT_MOC_LITERAL(13, 0),  // ""
        QT_MOC_LITERAL(14, 16),  // "signalWriteToLog"
...
void Log::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->initWork(); break;
        case 1: _t->signalWriteToLog((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Log::*)();
            if (_t _q_method = &Log::initWork; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (_t _q_method = &Log::signalWriteToLog; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 1
void Log::signalWriteToLog(QString _t1)
{
